 ...
 */
export async function editOrder(params: z.infer<typeof editOrderSchema>) {
  validateConfig();
 ...
 */
export async function cancelOrderByClientId(clientOrderId: string) {
  validateConfig();
 ...
 */
export async function cancelAllPendingOrders(symbol?: string) {
  validateConfig();
 ...
 */
export async function cancelAllAfter(params: z.infer<typeof cancelAllAfterSchema>) {
  validateConfig();
 ...
 */
export async function getOrderByClientId(clientOrderId: string) {
  validateConfig();
 ...
 */
export async function createAlgoOrder(params: z.infer<typeof algoOrderParamsSchema>) {
  validateConfig();
 ...
 * Edit an algo order
 */
export async function editAlgoOrder(params: z.infer<typeof editAlgoOrderSchema>) {
  validateConfig();
 ...
 */
export async function cancelAlgoOrder(orderId: string, symbol: string) {
  validateConfig();
 ...
 */
export async function cancelAlgoOrderByClientId(clientOrderId: string, symbol: string) {
  validateConfig();
 ...
 */
export async function cancelAllPendingAlgoOrders(symbol?: string) {
  validateConfig();
 ...
 */
export async function getAlgoOrders(params?: z.infer<typeof algoOrderQuerySchema>) {
  validateConfig();
 ...
 */
export async function getAlgoOrderById(orderId: string) {
  validateConfig();
 ...
 */
export async function getAlgoOrderByClientId(clientOrderId: string) {
  validateConfig();
